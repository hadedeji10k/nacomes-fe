      ...
      <div className="container mx-auto px-4 py-6 flex justify-between pl-[84px] mr-[-28px] pr-[25px]">
        <div className="">
          ...
          <div className="w-full sm:w-1/3 mb-4 sm:mb-0 mt-[-40px]">
            ...
            <p className="text-sm">
              The National Association of Computer Engineering Students
              (NACOMES) is the Head Student body for students studying Computer
              Engineering in the University of Maiduguri.
            </p>
          </div>
        </div>
